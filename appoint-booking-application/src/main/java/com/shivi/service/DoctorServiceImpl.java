...
public class DoctorServiceImpl implements DoctorService{
    ...
    @Override
    public List<LocalDateTime> getDoctorAvailableTimingForBooking(String key, Doctor doctor)
            throws IOException, TimeDateException, DoctorException {
        ...
        if(registerDoctor.isPresent()) {
            ...
            PatientServiceImpl.getAppointmentDates(registerDoctor.get().getAppointmentFromTime(),
                    registerDoctor.get().getAppointmentToTime());
            ...
            if(!doctorAvailableTiming.isEmpty()) {
                ...
                throw new DoctorException("No time and date available to book appointment. " +
                        "Please try again");
            }
    ...
    @Override
    public Review getReviewOfParticularAppointment(String key, Appointment appointment)
            throws PatientException, ReviewException {
