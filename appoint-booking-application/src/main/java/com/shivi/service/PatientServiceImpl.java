...
public class PatientServiceImpl implements PatientService, Runnable {
    ...
    public PatientServiceImpl(Appointment appointment, EmailSenderService emailSenderService,
                              EmailBody emailBody) {
    ...
    public Patient createPatient(Patient patient) throws PatientException {
        ...
        if(databaseUser == null) {
            ...
            throw new PatientException("Patient already register with this mobile no "
                    + patient.getMobileNo());
    ...
    @Override
    public CurrentSession getcurrentUserByUuid(String uuid) throws PatientException {
        return null;
    }
    ...
    public static void getAppointmentDates(Integer from, Integer to)
            throws IOException, TimeDateException{
    ...
    @Override
    public Appointment bookAppointment(String key, Appointment appointment) throws AppointmentException,
        ...
        synchronized (this) {
            ...
            if(patient.isPresent()) {
                ...
                if(!registerDoctors.isEmpty()) {
                    ...
                    getAppointmentDates(registerDoctors.get().getAppointmentFromTime(),
                            registerDoctors.get().getAppointmentToTime());
                    ...
                    for(Appointment eachAppointment: listOfAppointment) {
                        ...
                        if(eachAppointment.getAppointmentDateAndTime().isEqual(appointment
    ...
    @Override
    public List<Appointment> getAllAppointmentPatientWise(String key) throws AppointmentException, PatientException {
        return List.of();
    }
