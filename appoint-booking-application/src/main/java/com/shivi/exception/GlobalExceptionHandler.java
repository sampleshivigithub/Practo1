...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MyErrorDetails> patientExceptiionHandler
            (PatientException patientException, WebRequest webRequest){
    ...
    public ResponseEntity<MyErrorDetails> loginExceptiionHandler
            (LoginException loginException, WebRequest webRequest){
    ...
    public ResponseEntity<MyErrorDetails> AppointmentExceptiionHandler
            (AppointmentException appointmentException, WebRequest webRequest){
    ...
    public ResponseEntity<MyErrorDetails> doctorExceptiionHandler
            (DoctorException doctorException, WebRequest webRequest){
    ...
    public ResponseEntity<MyErrorDetails> timeDateExceptiionHandler
            (TimeDateException timeDateException, WebRequest webRequest){
    ...
    public ResponseEntity<MyErrorDetails> constraintExceptionHandler
            (MethodArgumentNotValidException constraintViolationException, WebRequest webRequest){
